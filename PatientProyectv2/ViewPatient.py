...
controller = ControllerPatientv2.ControllerPatientv2()
...
def addPatient():
        ...
        weight = input("Weight: ")
        age = input("Age: ")
        p = controller.addPatient(dni,date,name,surname,telephone,email,height,weight,age)
        return p
